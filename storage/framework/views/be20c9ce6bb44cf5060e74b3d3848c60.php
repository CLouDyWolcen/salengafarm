...
<head>
    ...
    <style>
        ...
        /* Separate code boxes styling - LIGHT like registration */
        ...
        /* Verify button - green modern like registration */
        .verify-btn-new {
            width: 100%;
            padding: 12px 20px;
            font-size: 15px;
        ...
        /* Custom checkbox styling - green - MATCH REGISTRATION EXACTLY */
        .form-check {
            display: flex;
            align-items: center;
            gap: 8px;
        ...
        <div class="card-body-custom">
            ...
            <?php else: ?>
                ...
                <form method="POST" action="<?php echo e(route('mfa.verify.post')); ?>" id="verifyForm">
                    ...
                    <!-- Remember device checkbox - MATCH REGISTRATION EXACTLY -->
