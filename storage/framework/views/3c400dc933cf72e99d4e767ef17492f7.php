...
<head>
    ...
    <link href="<?php echo e(asset('css/responsive-fixes.css')); ?>?v=<?php echo e(time()); ?>" rel="stylesheet">
    <style>
        /* Button Sizing Fixes */
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="exportDropdownUsers">
                                        ...
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu submenu">
                                                <li><a class="dropdown-item" href="<?php echo e(route('users.export', ['format' => 'xlsx', 'role' => 'all'])); ?>">
                                                    <i class="fas fa-file-excel me-2 text-success"></i>Excel (.xlsx)
                                                </a></li>
                                                <li><a class="dropdown-item" href="<?php echo e(route('users.export', ['format' => 'csv', 'role' => 'all'])); ?>">
                                        ...
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu submenu">
                                                <li><a class="dropdown-item" href="<?php echo e(route('users.export', ['format' => 'xlsx', 'role' => 'client'])); ?>">
                                                    <i class="fas fa-file-excel me-2 text-success"></i>Excel (.xlsx)
                                                </a></li>
                                                <li><a class="dropdown-item" href="<?php echo e(route('users.export', ['format' => 'csv', 'role' => 'client'])); ?>">
                                                    <i class="fas fa-file-csv me-2 text-info"></i>CSV (.csv)
                                                </a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu submenu">
                                                <li><a class="dropdown-item" href="<?php echo e(route('users.export', ['format' => 'xlsx', 'role' => 'admin'])); ?>">
                                                    <i class="fas fa-file-excel me-2 text-success"></i>Excel (.xlsx)
                                                </a></li>
                                                <li><a class="dropdown-item" href="<?php echo e(route('users.export', ['format' => 'csv', 'role' => 'admin'])); ?>">
                                                    <i class="fas fa-file-csv me-2 text-info"></i>CSV (.csv)
                                                </a></li>
                                            </ul>
                                        </li>
                                ...
                                <div class="card-body p-2">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <h4 class="mb-0 fw-bold"><?php echo e($stats['total_users']); ?></h4>
                                        </div>
                                ...
                                <div class="card-body p-2">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <h4 class="mb-0 fw-bold text-success"><?php echo e($stats['total_clients']); ?></h4>
                                        </div>
                                ...
                                <div class="card-body p-2">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <h4 class="mb-0 fw-bold text-danger"><?php echo e($stats['total_admins']); ?></h4>
                                        </div>
                                ...
                                <div class="card-body p-2">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <h4 class="mb-0 fw-bold text-info"><?php echo e($stats['new_this_month']); ?></h4>
                                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-user-id="<?php echo e($user->id); ?>">
                                            <td style="text-align: center;">
                                                <input type="checkbox" class="form-check-input user-checkbox" value="<?php echo e($user->id); ?>" style="width: 18px; height: 18px; cursor: pointer;">
                                            </td>
                                            ...
                                            <td class="text-end">
                                                <div class="btn-group" role="group">
                                                    <button type="button" class="btn btn-link text-info p-0 view-user-btn" 
                                                            ...
                                                            data-user-data="<?php echo e(json_encode($user)); ?>"
                                                            title="View Details">
                                                        <i class="fas fa-eye"></i>
                                                    </button>
                                                    <a href="<?php echo e(route('users.edit', $user)); ?>" class="btn btn-link text-success p-0" title="Edit">
                                        ...
                                        <tr>
                                            <td colspan="8" class="text-center py-4">
                                                ...
                                                <?php if(request('search') || request('role') != 'all'): ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#confirmBulkEdit').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("users.bulk-update")); ?>',
                    type: 'POST',
                    data: {
            ...
            $('#confirmBulkDelete').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route("users.bulk-delete")); ?>',
                    type: 'POST',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>',
                        user_ids: selectedIds
