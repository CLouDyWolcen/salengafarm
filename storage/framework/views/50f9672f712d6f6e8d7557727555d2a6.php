            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="exportDropdownRequests">
                ...
                <li class="dropdown-submenu">
                    ...
                    <ul class="dropdown-menu submenu">
                        <li><a class="dropdown-item" href="<?php echo e(route('requests.export', ['format' => 'xlsx', 'type' => 'all'])); ?>">
                            <i class="fas fa-file-excel me-2 text-success"></i>Excel (.xlsx)
                        </a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('requests.export', ['format' => 'csv', 'type' => 'all'])); ?>">
                ...
                <li class="dropdown-submenu">
                    ...
                    <ul class="dropdown-menu submenu">
                        <li><a class="dropdown-item" href="<?php echo e(route('requests.export', ['format' => 'xlsx', 'type' => 'client'])); ?>">
                            <i class="fas fa-file-excel me-2 text-success"></i>Excel (.xlsx)
                        </a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('requests.export', ['format' => 'csv', 'type' => 'client'])); ?>">
                            <i class="fas fa-file-csv me-2 text-info"></i>CSV (.csv)
                        </a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown-submenu">
                    ...
                    <ul class="dropdown-menu submenu">
                        <li><a class="dropdown-item" href="<?php echo e(route('requests.export', ['format' => 'xlsx', 'type' => 'user'])); ?>">
                            <i class="fas fa-file-excel me-2 text-success"></i>Excel (.xlsx)
                        </a></li>
                        <li><a class="dropdown-item" href="<?php echo e(route('requests.export', ['format' => 'csv', 'type' => 'user'])); ?>">
                            <i class="fas fa-file-csv me-2 text-info"></i>CSV (.csv)
                        </a></li>
                    </ul>
                </li>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                <?php if(session('warning')): ?>
                    if (window.PushNotifications) {
                        window.PushNotifications.show('warning', '<?php echo e(session('warning')); ?>', true);
                    }
                <?php endif; ?>
            });
        </script>
...
</html><?php /**PATH C:\CODING\my_Inventory\resources\views/admin/requests/index.blade.php ENDPATH**/ ?>