                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h2 class="card-title mb-0"><?php echo e($outOfStockItems->count()); ?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <ul class="nav nav-tabs nav-fill" role="tablist" style="border-bottom: 1px solid #dee2e6;">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="low-stock-tab" data-bs-toggle="tab" data-bs-target="#low-stock-content" type="button" role="tab" style="font-size: 0.85rem; padding: 0.5rem;">
                                        ...
                                        <span class="badge bg-warning text-dark ms-1"><?php echo e($lowStockItems->count()); ?></span>
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="out-stock-tab" data-bs-toggle="tab" data-bs-target="#out-stock-content" type="button" role="tab" style="font-size: 0.85rem; padding: 0.5rem;">
                                        ...
                                        <span class="badge bg-danger ms-1"><?php echo e($outOfStockItems->count()); ?></span>
                                    </button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $lowStockItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <div class="list-group-item">
                                                <div class="d-flex justify-content-between align-items-center w-100">
                                                    ...
                                                    <span class="badge bg-warning text-dark"><?php echo e($item->quantity); ?> left</span>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="out-stock-content" role="tabpanel">
                                    <div class="list-group list-group-flush">
                                        <?php $__empty_1 = true; $__currentLoopData = $outOfStockItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <div class="list-group-item">
                                                <div class="d-flex justify-content-between align-items-center w-100">
                                                    <div>
                                                        <h6 class="mb-0"><?php echo e(strtoupper($item->name)); ?></h6>
    ...
    <script>
        $(document).ready(function() {
            ...
            initStockChart('stockDistributionChart', {
                ...
                values: <?php echo json_encode(array_column($stockByCategory, 'quantity')); ?>
            ...
            initSalesChart('salesDistributionChart', {
                labels: <?php echo json_encode(array_keys($salesByCategory)); ?>,
                values: <?php echo json_encode(array_column($salesByCategory, 'quantity_percentage')); ?>,
                type: 'quantity'
            });
            <?php endif; ?>
