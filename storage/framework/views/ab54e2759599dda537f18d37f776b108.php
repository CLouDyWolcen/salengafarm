...
<?php endif; ?>
                    ...
                    <?php if(!auth()->user()->hasAdminAccess() && !auth()->user()->isProfileComplete()): ?>
                    <div class="alert alert-warning d-flex align-items-center mb-4" style="border-left: 4px solid #ffc107; padding: 1rem 1.25rem; border-radius: 8px;">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="mb-0" style="font-size: 0.9rem; margin-top: 0.25rem;">Your profile is <?php echo e(auth()->user()->getProfileCompletionPercentage()); ?>% complete. Complete it to unlock all features.</p>
                        </div>
                        <div class="ms-3">
                            <div class="progress" style="width: 200px; height: 24px; border-radius: 12px;">
                                <div class="progress-bar bg-warning" role="progressbar" 
                                     style="width: <?php echo e(auth()->user()->getProfileCompletionPercentage()); ?>%; font-weight: 600; font-size: 0.85rem; display: flex; align-items: center; justify-content: center;">
                                    <?php echo e(auth()->user()->getProfileCompletionPercentage()); ?>%
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <form method="post" action="<?php echo e(route('profile.update')); ?>" id="unifiedProfileForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="col-md-8 mb-4">
                <div class="profile-card h-100">
                    ...
                    <div class="card-body">
                                ...
                                <div class="d-flex gap-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="account_type" id="accountIndividual" 
                                               value="individual" <?php echo e(old('account_type', auth()->user()->account_type) === 'individual' ? 'checked' : ''); ?> required>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="account_type" id="accountCompany" 
                                               value="company" <?php echo e(old('account_type', auth()->user()->account_type) === 'company' ? 'checked' : ''); ?> required>
                            ...
                            <?php else: ?>
                            <input type="hidden" name="account_type" value="<?php echo e(auth()->user()->account_type ?? 'individual'); ?>">
                            <?php endif; ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="province" name="province" 
                                           value="<?php echo e(old('province', auth()->user()->province)); ?>" 
                                           placeholder="Province">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="zip_code" class="form-label">Zip Code <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="zip_code" name="zip_code" 
                                           value="<?php echo e(old('zip_code', auth()->user()->zip_code)); ?>" 
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control" id="property_type" name="property_type">
                                        ...
                                        <option value="residential" <?php echo e(old('property_type', auth()->user()->property_type) === 'residential' ? 'selected' : ''); ?>>Residential</option>
                                        <option value="commercial" <?php echo e(old('property_type', auth()->user()->property_type) === 'commercial' ? 'selected' : ''); ?>>Commercial</option>
                                        <option value="industrial" <?php echo e(old('property_type', auth()->user()->property_type) === 'industrial' ? 'selected' : ''); ?>>Industrial</option>
                                        <option value="agricultural" <?php echo e(old('property_type', auth()->user()->property_type) === 'agricultural' ? 'selected' : ''); ?>>Agricultural</option>
                                        <option value="mixed_use" <?php echo e(old('property_type', auth()->user()->property_type) === 'mixed_use' ? 'selected' : ''); ?>>Mixed Use</option>
                                        <option value="other" <?php echo e(old('property_type', auth()->user()->property_type) === 'other' ? 'selected' : ''); ?>>Other</option>
                                    </select>
                                    <input type="text" class="form-control mt-2" id="property_type_other" name="property_type_other" 
                                           value="<?php echo e(old('property_type_other', auth()->user()->property_type_other)); ?>"
                        ...
                        <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control" id="business_type" name="business_type">
                                            ...
                                            <option value="landscaping" <?php echo e(old('business_type', auth()->user()->business_type) === 'landscaping' ? 'selected' : ''); ?>>Landscaping</option>
                                            <option value="real_estate" <?php echo e(old('business_type', auth()->user()->business_type) === 'real_estate' ? 'selected' : ''); ?>>Real Estate</option>
                                            <option value="construction" <?php echo e(old('business_type', auth()->user()->business_type) === 'construction' ? 'selected' : ''); ?>>Construction</option>
                                            <option value="hospitality" <?php echo e(old('business_type', auth()->user()->business_type) === 'hospitality' ? 'selected' : ''); ?>>Hospitality</option>
                                            <option value="retail" <?php echo e(old('business_type', auth()->user()->business_type) === 'retail' ? 'selected' : ''); ?>>Retail</option>
                                            <option value="agriculture" <?php echo e(old('business_type', auth()->user()->business_type) === 'agriculture' ? 'selected' : ''); ?>>Agriculture</option>
                                            <option value="other" <?php echo e(old('business_type', auth()->user()->business_type) === 'other' ? 'selected' : ''); ?>>Other</option>
                                        </select>
                                        <input type="text" class="form-control mt-2" id="business_type_other" name="business_type_other" 
                                               value="<?php echo e(old('business_type_other', auth()->user()->business_type_other)); ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="tin" name="tin" 
                                               value="<?php echo e(old('tin', auth()->user()->tin)); ?>" 
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="website_socials" name="website_socials" 
                                               value="<?php echo e(old('website_socials', auth()->user()->website_socials)); ?>" 
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="company_address" name="company_address" 
                                           value="<?php echo e(old('company_address', auth()->user()->company_address)); ?>" 
                                           placeholder="Street, Barangay">
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="company_city" name="company_city" 
                                               value="<?php echo e(old('company_city', auth()->user()->company_city)); ?>" 
                                               placeholder="City">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="company_province" name="company_province" 
                                               value="<?php echo e(old('company_province', auth()->user()->company_province)); ?>" 
                                               placeholder="Province">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="company_zip_code" name="company_zip_code" 
                                               value="<?php echo e(old('company_zip_code', auth()->user()->company_zip_code)); ?>" 
                                               placeholder="Zip Code">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="company_contact_person" name="company_contact_person" 
                                               value="<?php echo e(old('company_contact_person', auth()->user()->company_contact_person)); ?>" 
                                               placeholder="Full Name">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="position" class="form-label">Position <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="position" name="position" 
                                               value="<?php echo e(old('position', auth()->user()->position)); ?>" 
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="tel" class="form-control" id="company_phone_number" name="company_phone_number" 
                                               value="<?php echo e(old('company_phone_number', auth()->user()->company_phone_number)); ?>" 
    ...
    <script>
        ...
        document.getElementById('updateAvatarBtn').addEventListener('click', function(e) {
            ...
            fetch('<?php echo e(route("profile.avatar.update")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
