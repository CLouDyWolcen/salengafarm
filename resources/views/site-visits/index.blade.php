                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="exportDropdownSiteVisits">
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu submenu">
                            <li><a class="dropdown-item" href="{{ route('site-visits.export', ['format' => 'xlsx', 'status' => 'all']) }}">
                                <i class="fas fa-file-excel me-2 text-success"></i>Excel (.xlsx)
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('site-visits.export', ['format' => 'csv', 'status' => 'all']) }}">
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu submenu">
                            <li><a class="dropdown-item" href="{{ route('site-visits.export', ['format' => 'xlsx', 'status' => 'pending']) }}">
                                <i class="fas fa-file-excel me-2 text-success"></i>Excel (.xlsx)
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('site-visits.export', ['format' => 'csv', 'status' => 'pending']) }}">
                                <i class="fas fa-file-csv me-2 text-info"></i>CSV (.csv)
                            </a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu submenu">
                            <li><a class="dropdown-item" href="{{ route('site-visits.export', ['format' => 'xlsx', 'status' => 'completed']) }}">
                                <i class="fas fa-file-excel me-2 text-success"></i>Excel (.xlsx)
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('site-visits.export', ['format' => 'csv', 'status' => 'completed']) }}">
                                <i class="fas fa-file-csv me-2 text-info"></i>CSV (.csv)
                            </a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu submenu">
                            <li><a class="dropdown-item" href="{{ route('site-visits.export', ['format' => 'xlsx', 'status' => 'follow_up']) }}">
                                <i class="fas fa-file-excel me-2 text-success"></i>Excel (.xlsx)
                            </a></li>
                            <li><a class="dropdown-item" href="{{ route('site-visits.export', ['format' => 'csv', 'status' => 'follow_up']) }}">
                                <i class="fas fa-file-csv me-2 text-info"></i>CSV (.csv)
                            </a></li>
                        </ul>
                    </li>
